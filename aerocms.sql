...
(1, 1, 'This is my first post using AeroCMS!', '', 'admin', '2021-10-05', 'olympus.jpg', '<p>This is how i tried to climb Mt. Olympus!\n<p> Mount Olympus is the highest mountain in Greece. At a height of 2,918m above sea level, it towers over Northern Greece, and can be seen as far away as Thessaloniki. It is situated on the borders of Thessaly and Macedonia.
...
Situated on the E4 route, there are many paths that can be followed around the mountain, that all have a pleasant and wonderful scenery, that will make any trek well worth the effort. The journey to the top can begin at Litochoro, where the E4 starts on Olympus, or you can begin the climb at the last car park at Prionia. The trek can be done quite easily over a pleasant two days, but with this much beauty, why not spend some time taking it in, and that amazing tranquil silence. !</p>\r\n<p>&nbsp;</p>\r\n<p>Credits:</p>\r\n<p>&nbsp;</p>\r\n<p>Photo by Me</p>', 'aerocms, start guide, aero, cms, guide, user credentials, getting started', 0, 'published', 1),

(2, 2, 'Refuge', '', 'admin', '2021-10-06', 'agapitos.jpeg', '<p>In the first night we stayed on Refuge A(Spilios Agapitos). The refuge itself is spacious and well-equipped to handle upto 110 sleeping visitors. It houses the necessary cooking facilities that can serve guests in two large dining areas. All the necessary sanitary facilities are also provided in both of the refuges sleeping areas.  </p>', 'mysql, database', 0, 'published', 1);
...
(1, 'admin', '$2a$12$M8KMzrASFLbF.tEyC5bGRebyfk/.wyQn0yt39GbZi8TfixfgKo9Zm', NULL, NULL, 'admin@example.net', NULL, 'Admin', '$2y$10$iusesomecrazystrings22');
